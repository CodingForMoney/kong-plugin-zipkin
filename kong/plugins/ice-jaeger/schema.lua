  ...
  fields = {
    { config = {
        ...
        fields = {
          ...
          { header_type = { type = "string", required = true, default = "ice-jaeger",
                            one_of = { "preserve", "b3", "b3-single", "w3c", "ice-jaeger" } } },
          { default_header_type = { type = "string", required = true, default = "ice-jaeger",
                                    one_of = { "b3", "b3-single", "w3c", "ice-jaeger" } } },
